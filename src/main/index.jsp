...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=resources/static/alipay.trade.page.pay.jsp method=post
			  target="_blank">
		...
		<form name=tradequery action=resources/static/alipay.trade.query.jsp method=post
			  target="_blank">
		...
		<form name=traderefund action=resources/static/alipay.trade.refund.jsp method=post
			  target="_blank">
		...
		<form name=traderefundquery
			  action=resources/static/alipay.trade.fastpay.refund.query.jsp method=post
			  target="_blank">
		...
		<form name=tradeclose action=resources/static/alipay.trade.close.jsp method=post
			  target="_blank">
